# Hostlife Installation Script for Windows
# This script automates the setup of Hostlife on Windows
...
# Start script
Write-Header "Hostlife Installation Script"
...
if (-not $script:skipEnv) {
    ...
    $envContent = "# Hostlife Environment Variables`n"
...
# Start services
Write-Header "Starting Hostlife"
...
Write-Host ""
Write-Success "Hostlife is now running!"
Write-Host ""
Write-Host "Access Information:"
Write-Host "  - Hostlife: http://$domain or https://$domain"
if ($enableAuthentik -eq "y" -or $enableAuthentik -eq "Y") {
