...
# Hostlife Installation Script
# This script automates the setup of Hostlife
...
print_header "Hostlife Installation Script"
...
if [ "$SKIP_ENV" != "true" ]; then
    ...
    cat > .env << EOF
# Hostlife Environment Variables
...
# Start services
print_header "Starting Hostlife"
...
echo ""
print_success "Hostlife is now running!"
echo ""
echo "Access Information:"
echo "  - Hostlife: http://$DOMAIN or https://$DOMAIN"
