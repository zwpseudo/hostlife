...
**hostlife** is a free and completely open-source alternative to Kasm Workspaces, enabling secure container streaming for your applications.
...
```shell
curl -L https://raw.githubusercontent.com/zwpseudo/hostlife/refs/heads/main/docker-compose.yml -o docker-compose.yml
```
